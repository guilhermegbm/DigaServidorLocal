 ...
 * @author Guilherme
 */
@WebServlet(name = "DesreportaOcorrencia", urlPatterns = {"/diga_api/DesreportaOcorrencia"}, initParams = {
    @WebInitParam(name = "nomeUsuario", value = "")
    , @WebInitParam(name = "senha", value = "")
    , @WebInitParam(name = "usuario", value = "")
    , @WebInitParam(name = "ocorrencia", value = "")})
public class DesreportaOcorrencia extends HttpServlet{
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (ControleUsuario.autenticaUsuario(request.getParameter("nomeUsuario"), request.getParameter("senha"))) {
            ...
            response.setHeader("sucesso", ControleOcorrencia.desreportaOcorrencia(usuario, ocorrencia));
        } else {
